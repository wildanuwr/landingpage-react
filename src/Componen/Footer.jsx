      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            <h2 className="text-4xl font-bold tracking-tight text-white">Daftar untuk Newsletter Kami!</h2>
            <p className="mt-4 text-lg text-gray-200">
              Dapatkan berita terbaru dan penawaran eksklusif langsung ke email Anda. Bergabunglah sekarang juga!
            </p>
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <dt className="mt-4 text-base font-semibold text-white">Artikel Setiap Minggu</dt>
            ...
            <div className="flex flex-col items-start">
              ...
              <dt className="mt-4 text-base font-semibold text-white">Tanpa Iklan</dt>
              <dd className="mt-2 text-base/7 text-gray-300">
                Kami berkomitmen untuk tidak mengirimkan iklan. Hanya informasi yang bermanfaat.
              </dd>
            </div>
          </dl>
        </div>
